    ...
    <section id="showcase" className="bg-background-secondary py-24 md:py-40">
      <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
        ...
        <div style={{ perspective: "1200px" }}>
          ...
          >
            <Image
              src="/images/projects/bedroom-maroon-03.jpg"
              alt="Full interior view of a designed bedroom with numbered hotspots for lighting, furniture, flooring, wall finish and decor"
              fill
